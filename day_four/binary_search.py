...
# and b is the step or difference between consecutive values. It should also initialize an instance 
...
class BinarySearch():
	...
	def search():
		"""
		should return a dictionary object with
		count - no of times fxn iterated to find index of the number in qtn
		index - index of the number in qtn
		"""
		pass